...
### Панель через домен (Path B)
При наличии домена с валидным SSL-сертификатом панель 3x-ui доступна напрямую — SSH-туннель не нужен:
```
